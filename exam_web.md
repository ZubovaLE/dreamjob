...
2. [Как добавить изменения в индекс?](#Как-добавить-изменения-в-индекс)
3. [Как сделать фиксацию изменений?](#Как-сделать-фиксацию-изменений)
...
5. [Как синхронизироваться с удаленным репозиторием?](#Как-синхронизироваться-с-удаленным-репозиторием)
6. [Как создать ветку?](#Как-создать-ветку)
